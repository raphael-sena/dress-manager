    ...
    >
      <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
        ...
        <div className="flex flex-col">
          <header className="flex h-14 items-center gap-3 border-b bg-white/90 px-5 py-10 md:h-[60px] lg:px-6">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black sm:py-6 md:py-8">
              Gestão de Estoque
            </h1>
          ...
          <main className="flex flex-1 flex-col gap-4 w-screen sm:w-full max-w-full box-border">
            {children}
          </main>
        </div>
      </div>
